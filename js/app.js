...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function actualizarResumen() {
    ...
    if (productosAgregados.length === 0) {
      listaResumenItems.innerHTML = `
                <li class="list-group-item bg-dark text-muted small text-center border-secondary">
      ...
      alertaDomicilio.className =
        "alert alerta-domicilio-custom py-1 px-2 my-2 text-center small";

      alertaDomicilio.textContent =
        "Domicilio gratis por compras mayores a $30.000";
    ...
    productosAgregados.forEach((item, indice) => {
      ...
      li.className =
        "list-group-item bg-dark text-white d-flex justify-content-between align-items-center border-secondary px-0 small";
    ...
    if (costoDomicilio === 0) {
      ...
      alertaDomicilio.className =
        "alert alerta-domicilio-gratis py-1 px-2 my-2 text-center small";
      ...
      alertaDomicilio.textContent =
        "Agrega " + formatearMoneda(faltante) + " más para domicilio gratis.";
    }
  ...
  function cargarHistorialPedidos() {
    ...
    if (pedidos.length === 0) {
      tablaHistorial.innerHTML = `
                <tr>
                    <td colspan="6" class="text-center text-light py-3">
